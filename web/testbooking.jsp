                    ...
                    <form method="POST" action="BookingServlet" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div id="pickupMap" class="w-full h-56 md:h-64 lg:h-72 bg-gray-200 rounded-lg"></div>
                            ...
                            <div>
                                ...
                                <div id="destinationMap" class="w-full h-56 md:h-64 lg:h-72 bg-gray-200 rounded-lg"></div>
